...
class LSTM(object):
    ...
    def do_identification(self, data_number):
        ...
        matlab_script_name = 'matlab_lstm.m'  # ### Find the path first, later change to pathlib
        ...
        l_b_u_w, l_b_f_w, l_b_c_w, l_b_o_w, l_cell_x, l_hidden_x, n_w, n_b, x_min, x_max, error, loss \
            = eng.matlab_lstm(mat_u, mat_y, self.node_num, self.learning_rate, self.plot_bool, nargout=20)
        eng.quit()
